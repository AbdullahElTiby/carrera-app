import '../ongoing_screen/widgets/ongoing_item_widget.dart';
import '../ongoing_screen/widgets/sliderrectanglesixteen1_item_widget.dart';
...
class OngoingScreen extends GetWidget<OngoingController> {
  @override
            ...
            child: Column(
              ...
              children: [
                ...
                AppbarDropdown(
                  ...
                  items: controller.ongoingModelObj.value.dropdownItemList,
                  onTap: (value) {
                  ...
                  Padding(
                    ...
                    child: Obx(
                      () => CarouselSlider.builder(
                        ...
                        itemCount: controller.ongoingModelObj.value
                            .sliderrectanglesixteen1ItemList.length,
                        itemBuilder: (context, index, realIndex) {
                          Sliderrectanglesixteen1ItemModel model = controller
                              .ongoingModelObj
                              .value
                              .sliderrectanglesixteen1ItemList[index];
                          return Sliderrectanglesixteen1ItemWidget(
                            model,
                          );
                        },
                      ),
                  ...
                  Obx(
                    () => Container(
                      ...
                      child: AnimatedSmoothIndicator(
                        ...
                        count: controller.ongoingModelObj.value
                            .sliderrectanglesixteen1ItemList.length,
                                ...
                                Padding(
                                  ...
                                  child: Obx(
                                    () => ListView.separated(
                                      ...
                                      itemCount: controller.ongoingModelObj
                                          .value.ongoingItemList.length,
                                      itemBuilder: (context, index) {
                                        OngoingItemModel model = controller
                                            .ongoingModelObj
                                            .value
                                            .ongoingItemList[index];
