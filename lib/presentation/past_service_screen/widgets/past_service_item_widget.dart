...
class PastServiceItemWidget extends StatelessWidget {
  PastServiceItemWidget(this.pastServiceItemModelObj);

  PastServiceItemModel pastServiceItemModelObj;

  var controller = Get.find<PastServiceController>();
